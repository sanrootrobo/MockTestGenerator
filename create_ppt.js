...
// --- All other helper functions for slide creation remain the same ---
...
// --- SLIDE CREATION FUNCTIONS (Unchanged) ---
...
async function main() {
    ...
    if (args.includes('--help') || args.includes('-h')) {
        showHelp();
        return; // Exit peacefully after showing help
    }
    if (args.length < 2) {
    ...
    try {
        // 2. Validate inputs before starting
        ...
        // 3. Parse JSON data with specific error handling
        ...
        // 5. Catch any errors and report them cleanly
