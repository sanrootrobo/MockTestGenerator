...
2. **Generate Original Content:**
   ...
   * For General Awareness questions: Base them on events, policies, appointments, awards, economic developments, and international affairs mentioned in the 2025 current affairs files, but frame them as original analytical questions.
...
3. **Content Requirements for X-GMT Format:**
   * **Section 1: General Awareness (20 questions)** - Must be based exclusively on 2025 current affairs documents
...
4. **Question Quality Standards:**
   ...
   * **General Awareness**: Focus on "why" behind events, strategic implications, cause-effect relationships, and connections between multiple pieces of information from 2025 docs
             ...
             "questions": [
               {
                 ...
                 "solution": {
                   ...
                   "sourceDocument": "String" // For GA questions: which 2025 document (e.g., "May 2025")
                 }
               }
             ]
           }
...
7. **Answer Key Requirements:**
   * **For General Awareness Questions:**
     - Provide background context from 2025 documents
     ...
     - Connect to broader significance within 2025 context
...
8. **Content Authenticity:**
   ...
   * Generate content that reflects 2025 contemporary context and current business/management practices.
...
9. **Critical Restrictions:**
   * NO SVG diagrams or visual reasoning questions (as specified in user requirements)
   * NO direct copying from reference materials
   * General Awareness questions MUST derive from provided 2025 current affairs files only
