...
1.  **Analyze Reference Materials:**
   ...
   * **CRITICAL**: Study the provided "REFERENCE Mock Dir" materials thoroughly. This directory may contains current affairs content .txt format, that MUST be used exclusively as the source for all General Awareness questions. All GA questions must be derived from the information contained within these reference mock .txt materials.
